...
export class GenerateService {
  ...
  generateExcel(project: Project) {
    ...
    if (project.type === 'Budget') {
      header.push('Title', 'Category', 'Amount', 'Description');
    } else {
      header.push('Title',  'Amount', 'Description');
    }
    ...
    worksheet.addRow(['Total amount : ' , project.totalAmount + ' € ']);
    ...
    let totalRow ;
    if (project.type === 'Budget') {
       totalRow = worksheet.addRow(['Total amount :', '', project.totalAmount ]);
    } else {
       totalRow = worksheet.addRow(['Total amount :', project.totalAmount]);
    }
    ...
    worksheet.addRow([]);
    // Footer Row
    const footerRow = worksheet.addRow(['This excel sheet is generated by Calcapp.io.']);
